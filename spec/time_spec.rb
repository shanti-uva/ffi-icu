  ...
  describe TimeFormatting do
    describe 'the TimeFormatting ' do
      ...
      it 'check date_format for lang=cs_CZ' do
        expect(f1.date_format(true)).to eql "d. MMMM y H:mm:ss ZZZZ"
        expect(f1.date_format(false)).to eql "d. MMMM y H:mm:ss ZZZZ"
      end
      ...
      it 'check date_format for lang=en_US' do
        expect(f2.date_format(true)).to eql en_exp
        expect(f2.date_format(false)).to eql en_exp
      end

      it "lang=en_US zone=Europe/Moscow" do
        expect(f2.format(t0)).to eql "11/12/08#{en_sep} 5:21:16 PM #{en_tz}"
        expect(f2.format(t1)).to eql "10/25/08#{en_sep} 3:15:17 AM #{en_tz}"
        expect(f2.format(t2)).to eql "10/25/08#{en_sep} 4:16:18 AM #{en_tz}"
        expect(f2.format(t3)).to eql "10/25/08#{en_sep} 5:17:19 AM #{en_tz}"
        expect(f2.format(t4)).to eql "10/25/08#{en_sep} 6:18:20 AM #{en_tz}"
        expect(f2.format(t5)).to eql "3/29/08#{en_sep} 3:35:21 AM #{en_tz}"
        expect(f2.format(t6)).to eql "3/29/08#{en_sep} 4:36:22 AM #{en_tz}"
        expect(f2.format(t7)).to eql "3/29/08#{en_sep} 5:37:23 AM #{en_tz}"
        expect(f2.format(t8)).to eql "3/29/08#{en_sep} 6:38:24 AM #{en_tz}"
      end
      ...
      it 'check date_format for lang=de_DE' do
        expect(f3.date_format(true)).to eql ge_exp
        expect(f3.date_format(false)).to eql ge_exp
      end

      it "lang=de_DE zone=Africa/Dakar" do
        expect(f3.format(t0)).to eql "12.11.08#{ge_sep} 14:21:16 GMT"
        expect(f3.format(t1)).to eql "24.10.08#{ge_sep} 23:15:17 GMT"
        expect(f3.format(t2)).to eql "25.10.08#{ge_sep} 00:16:18 GMT"
        expect(f3.format(t3)).to eql "25.10.08#{ge_sep} 01:17:19 GMT"
        expect(f3.format(t4)).to eql "25.10.08#{ge_sep} 02:18:20 GMT"
        expect(f3.format(t5)).to eql "29.03.08#{ge_sep} 00:35:21 GMT"
        expect(f3.format(t6)).to eql "29.03.08#{ge_sep} 01:36:22 GMT"
        expect(f3.format(t7)).to eql "29.03.08#{ge_sep} 02:37:23 GMT"
        expect(f3.format(t8)).to eql "29.03.08#{ge_sep} 03:38:24 GMT"
      end
    end
  end
end
