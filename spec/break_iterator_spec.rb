...
module ICU
  describe BreakIterator do
    ...
    it "finds all word boundaries in an English string" do
      ...
      expect(iterator.to_a).to eq [0, 5, 6, 11, 12, 17, 18, 21, 22, 26, 27, 28, 39, 40, 51, 52, 56, 57, 58, 61, 62, 64, 65, 72, 73, 79, 80, 90, 91, 93, 94, 100, 101, 103, 104, 110, 111, 116, 117, 123, 124]
    end
